...
STRATEGY_LIQ_MAX_SPREAD_ABS_DOLLARS = _env_float("STRATEGY_LIQ_MAX_SPREAD_ABS_DOLLARS", 0.01)
...
# Market quality
MAX_SPREAD_PCT = 0.15
MAX_SPREAD_ABS_DOLLARS = 0.01
MIN_BOOK_SIZE = 5

# Ops alerting
INGEST_STALE_ALERT_HOURS = _env_float("INGEST_STALE_ALERT_HOURS", 48.0)
